...
public class NVPAPICaller
{
    ...
    public string APIUsername = "xransomx-facilitator_api1.gmail.com";
    private string APIPassword = "TE9THDBUNDRC2NQX";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AgRICuF1CVh.0m.8APsl0w6GOkaK";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44388/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44388/CheckoutCancel.aspx";
        ...
        encoder["BRANDNAME"] = "Fitasia gym pass";
        encoder["PAYMENTREQUEST_0_AMT"] = amt;
        //encoder["PAYMENTREQUEST_0_ITEMAMT"] = "1";
    ...
    public string HttpCall(string NvpRequest)
    {
        ...
        {
            ExceptionUtility.LogException(e,"HTTPCALL writting");
        }
